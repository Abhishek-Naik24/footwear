                                    ...
                                    <div className="row">
                                        <div className="col-md-12 text-center">
                                            <div className="block-27">
                                                <ul>
                                                    <li onClick={handlePrevious} style={{ cursor: currentPage === totalPages ? 'default' : 'pointer' }}><a ><i className="ion-ios-arrow-back"></i></a></li>
                                                    {
                                                    ...
                                                    <li onClick={handleNext} style={{ cursor: currentPage === totalPages ? 'default' : 'pointer' }}><a href='#'><i className="ion-ios-arrow-forward"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div> : ''
